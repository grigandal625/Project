...
const sendUTZ = async (name, description, data, ka_topic_id, weight) => {
    ...
    const body = { name, description, data: JSON.stringify(data), ka_topic_id, weight };
    ...
    return (
        <>
            <Navbar bg="light" expand="lg">
                <Container>
                    <Navbar.Brand>Создание УТЗ "Построение иерархической структуры"</Navbar.Brand>
            ...
            <Container>
                <Row>
                    ...
                    <Col xs={2} className="text-right">
                        <Button style={{ width: "100%" }} onClick={() => sendUTZ(name, desc, JSON.stringify(nodes[0]), topic, weight)}>
                            Создать
                        </Button>
                    </Col>
                </Row>
                <FormGroup>
                    ...
                    <Form.Control value={name} onChange={(e) => setName(e.target.value)} name="name" placeholder="Введите название УТЗ"></Form.Control>
                </FormGroup>
                <FormGroup>
                    <Form.Label htmlFor="desc">Описание задания</Form.Label>
                    <Form.Control value={desc} onChange={(e) => setDesc(e.target.value)} as="textarea" placeholder="Введите описание задания" name="desc"></Form.Control>
                </FormGroup>
                <FormGroup>
                ...
                <Row>
                    ...
                    <Col>
                        <FormGroup>
                            ...
                            <Form.Control type="number" placeholder="Укажите вес" value={weight} onChange={(e) => setWeight(e.target.value)}></Form.Control>
                        </FormGroup>
                    </Col>
                </Row>
            </Container>
