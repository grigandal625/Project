...
$(document).ready(function () {
    ...
    $("#add_row").click(function () {
        ...
        $tr = $(
            '<tr class="drag"><td><center><span class="image_add">+</span></center></td><td><img class="preview-img"></td><td><input id="' +
                rand +
                '" type="file" name="images[]" style="opacity: 0; width: 0; height: 0"></td><td><center><small><button id="row_del" type="button" class="btn btn-danger btn-xs del" value="1">del</button></small></center></td></tr>'
        );
        $("#rows").append($tr);
    ...
    $("#done").click(function () {
        ...
        json.images = images;
        json.goal =
            $("#task_aim")[0].text == "Введите цель задачи"
                ? ""
                : $("#task_aim")[0].text;
        json.theme =
            $("#task_theme")[0].text == "Введите тему задачи"
                ? ""
                : $("#task_theme")[0].text;
